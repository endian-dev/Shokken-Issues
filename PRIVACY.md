...
- **Issue tracker interactions:** Any information submitted to this repository (e.g., GitHub usernames, comments, attachments) is additionally subject to GitHub's own privacy terms.
...
- Access, correct, or delete your account data via in-app settings or by emailing [privacy@shokken.rsvp](mailto:privacy@shokken.rsvp).
